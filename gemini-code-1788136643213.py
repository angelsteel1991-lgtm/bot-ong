...
def set_margin_type():
    ...
    try:
        ...
        log(
            f"Margin type "
            f"(puede que ya estuviera seteado): {e}"
        )
...
def calculate_quantity(price):
    ...
    dynamic_margin = (
        calculate_margin_by_volatility(
            price
        )
    )
    ...
    if notional < MIN_NOTIONAL:
        ...
        raise Exception(
            ...
            f"por debajo del minimo permitido "
            f"({MIN_NOTIONAL} USDT)"
        )
